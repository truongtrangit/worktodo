...
const SignUp = (props) => {
    ...
    const handleCreateAccount = (e) => {
        e.preventDefault()
        axios.post(`${backend_url}/signUp`, { email, password, name })
        .then(result => {
          ...
          <div className="wrap-login100">
            <form className="login100-form validate-form">
              ...
              <div
                ...
                data-validate="Enter password"
              >
                <input className="input100" type="text" name="name" onChange={(e) => setName(e.target.value)}/>
                <span className="focus-input100" data-placeholder="Your Name"></span>
              </div>

              <div className="container-login100-form-btn">
                <div className="wrap-login100-form-btn">
                  <div className="login100-form-bgbtn"></div>
                  <button className="login100-form-btn" onClick={handleCreateAccount}>Create Account</button>
                </div>
              </div>
