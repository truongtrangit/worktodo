...
class AddForm extends Component {
  ...
  onSubmit = (e) => {
    ...
    if(name === ''){
      ...
      e.preventDefault()
      this.props.AddNewWork({ id, name, status })
      this.resetValue(e)
    }
  }
  ...
  componentWillMount() {
    if(this.props.valueEditting) {
      this.setState({
        id: this.props.valueEditting.id,
        ...
        <div className="panel-body">
          <form onSubmit={this.onSubmit}>
            ...
            <div className='text-center'>
              <button className="btn btn-success"> <i className="fas fa-plus"></i> { this.state.id === '' ? 'Add' : 'Save' }</button> &nbsp;
